...
export function SupportButton(){return <button className="pt-button pt-support-trigger" onClick={openSupport}>Wir sind für dich da <span aria-hidden="true">↗</span></button>}
